...
/// tout juste ajouté pour le test, à enlever
/** @brief CLI function for AOloopControl_WFSzpupdate_loop */
int_fast8_t AOloopControl_WFSzpupdateloop_cli() {
    if(CLI_checkarg(1,4)+CLI_checkarg(2,4)+CLI_checkarg(3,4)==0) {
        AOloopControl_WFSzpupdate_loop(data.cmdargtoken[1].val.string, data.cmdargtoken[2].val.string, data.cmdargtoken[3].val.string);
        return 0;
    }
...
/** @brief CLI function for AOloopControl_set_complatency_frame 
	latency for the primary DM write */
...
/** @brief CLI function for AOloopControl_set_wfsmextrlatency_frame 
	delay between the time when the WFS measures and the time when commands are sent to the DM */
...
//////////////////////////////////////////
// begin declaring fonctions for Filtering 
//////////////////////////////////////////
/*
limit_total = limit_global * limit_block * limit_mode 
gain_total = gain_global * gain_block * gain_mode 
*/
...
/** @brief CLI function for AOloopControl_setgainblock (filtering) */
...
/** @brief CLI function for AOloopControl_setlimitblock (filtering) */
...
/** @brief CLI function for AOloopControl_setmultfblock / coeff MULTF (filtering) */
...
/** @brief CLI function for AOloopControl_scanGainBlock (filtering) */
...
////////////////////////////////////////
// end declaring fonctions for Filtering 
////////////////////////////////////////
...
// set command line interface , parameters
